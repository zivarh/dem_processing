...
"""
File "/Users/zivarhagverdiyeva/Documents/dem/test/slope_calculation_test.py", line 3, in __main__
Failed example:
    calculate_max_slopes(test)
Exception raised:
    Traceback (most recent call last):
      ...
      File "<doctest __main__[1]>", line 1, in <module>
        calculate_max_slopes(test)
      File "/Users/zivarhagverdiyeva/Documents/dem/test/slope_calculation_test.py", line 17, in calculate_max_slopes
        rows, cols = raster.shape
                     ^^^^^^^^^^^^
    AttributeError: 'tuple' object has no attribute 'shape'
**********************************************************************
File "/Users/zivarhagverdiyeva/Documents/dem/test/slope_calculation_test.py", line 5, in __main__
Failed example:
    calculate_max_slopes(np.array(test))
Expected nothing
Got:
